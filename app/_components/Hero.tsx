        ...
        <div className="mx-auto max-w-xl text-center">
          <h1 className="text-3xl text-sky-300 font-extrabold sm:text-5xl">
            ...
            <strong className="font-extrabold text-white sm:block">
              Collaborate with friends </strong>
          </h1>
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-40">
            <a
            ...
            <p className="mt-4 sm:text-xl/relaxed text-red-700 ">
              Please register first to use !!
            </p>
